...
This fork is mainly for HL1RT: Blue Shift, but it works with the original HL1 game as well, although the improvements like dirty water etc. are not implemented in it.
- FSR3 support
- Support for "dirty" water (Water color, water density for inscattering)
- DLSS4 support
- Up to date with upstream Xash-FWGS
- DLSS ray reconstruction support
- Better de-noising technology

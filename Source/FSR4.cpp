...
void CheckError( FfxErrorCode r )
{
    if( r != FFX_OK )
    {
        RTGL1::debug::Error( "FSR4: Fail, FfxErrorCode={}", r );
        throw RTGL1::RgException( RG_RESULT_GRAPHICS_API_ERROR, "Can't initialize FSR4" );
    }
}
}
...
RTGL1::FSR4::FSR4( VkDevice _device, VkPhysicalDevice _physDevice, bool _enableFrameGeneration )
    : device( _device )
...
FfxResource ToFSR4Resource( RTGL1::FramebufferImageIndex  fbImage,
                            uint32_t                      frameIndex,
    ...
    bool                                   resetAccumulation )
{
    ...
    FfxFsr3UpscalerDispatchDescription info = {
        ...
        .color                      = ToFSR4Resource( FI::FB_IMAGE_INDEX_FINAL, frameIndex, *framebuffers, renderResolution.GetResolutionState(), FFX_RESOURCE_STATE_COMPUTE_READ, L"FSR4_InputColor" ),
        .depth                      = ToFSR4Resource( FI::FB_IMAGE_INDEX_DEPTH_NDC, frameIndex, *framebuffers, renderResolution.GetResolutionState(), FFX_RESOURCE_STATE_COMPUTE_READ, L"FSR4_InputDepth" ),
        .motionVectors              = ToFSR4Resource( FI::FB_IMAGE_INDEX_MOTION_DLSS, frameIndex, *framebuffers, renderResolution.GetResolutionState(), FFX_RESOURCE_STATE_COMPUTE_READ, L"FSR4_InputMotionVectors" ),
        .exposure                   = {},
        .reactive                   = ToFSR4Resource( FI::FB_IMAGE_INDEX_REACTIVITY, frameIndex, *framebuffers, renderResolution.GetResolutionState(), FFX_RESOURCE_STATE_COMPUTE_READ, L"FSR4_InputReactivity" ),
        ...
        .output                     = ToFSR4Resource( OUTPUT_IMAGE_INDEX, frameIndex, *framebuffers, renderResolution.GetResolutionState(), FFX_RESOURCE_STATE_UNORDERED_ACCESS, L"FSR4_OutputColor" ),
...
RgFloat2D RTGL1::FSR4::GetJitter(const RTGL1::ResolutionState &resolutionState, uint32_t frameId)
{
    return {};
}

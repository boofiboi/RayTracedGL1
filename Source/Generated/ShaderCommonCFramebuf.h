...
enum FramebufferImageIndex
{
    ...
    FB_IMAGE_INDEX_WATER_PARAMS = 20,
    ...
    FB_IMAGE_INDEX_REACTIVITY = 27,
    FB_IMAGE_INDEX_ACCUM_HISTORY_LENGTH = 28,
    FB_IMAGE_INDEX_ACCUM_HISTORY_LENGTH_PREV = 29,
    FB_IMAGE_INDEX_DIFF_TEMPORARY = 30,
    FB_IMAGE_INDEX_DIFF_ACCUM_COLOR = 31,
    FB_IMAGE_INDEX_DIFF_ACCUM_COLOR_PREV = 32,
    FB_IMAGE_INDEX_DIFF_ACCUM_MOMENTS = 33,
    FB_IMAGE_INDEX_DIFF_ACCUM_MOMENTS_PREV = 34,
    FB_IMAGE_INDEX_DIFF_COLOR_HISTORY = 35,
    FB_IMAGE_INDEX_DIFF_PING_COLOR_AND_VARIANCE = 36,
    FB_IMAGE_INDEX_DIFF_PONG_COLOR_AND_VARIANCE = 37,
    FB_IMAGE_INDEX_SPEC_ACCUM_COLOR = 38,
    FB_IMAGE_INDEX_SPEC_ACCUM_COLOR_PREV = 39,
    FB_IMAGE_INDEX_SPEC_PING_COLOR = 40,
    FB_IMAGE_INDEX_SPEC_PONG_COLOR = 41,
    FB_IMAGE_INDEX_INDIR_ACCUM = 42,
    FB_IMAGE_INDEX_INDIR_ACCUM_PREV = 43,
    FB_IMAGE_INDEX_INDIR_PING = 44,
    FB_IMAGE_INDEX_INDIR_PONG = 45,
    FB_IMAGE_INDEX_ATROUS_FILTERED_VARIANCE = 46,
    FB_IMAGE_INDEX_HISTOGRAM_INPUT = 47,
    FB_IMAGE_INDEX_NORMAL_DECAL = 48,
    FB_IMAGE_INDEX_SCATTERING = 49,
    FB_IMAGE_INDEX_SCATTERING_PREV = 50,
    FB_IMAGE_INDEX_SCATTERING_HISTORY = 51,
    FB_IMAGE_INDEX_SCATTERING_HISTORY_PREV = 52,
    FB_IMAGE_INDEX_ACID_FOG_R_T = 53,
    FB_IMAGE_INDEX_ACID_FOG = 54,
    FB_IMAGE_INDEX_SCREEN_EMIS_R_T = 55,
    ...
    FB_IMAGE_INDEX_NRD_DIFFUSE_HIT_DIST = 69,
    FB_IMAGE_INDEX_NRD_SPECULAR_HIT_DIST = 70,
    FB_IMAGE_INDEX_NRD_NORMAL_ROUGHNESS = 71,
    FB_IMAGE_INDEX_NRD_VIEW_Z = 72,
    FB_IMAGE_INDEX_NRD_OUT_DIFFUSE = 73,
    FB_IMAGE_INDEX_NRD_OUT_SPECULAR = 74,
